...
<body style="background :	#F0E68C">
	...
	<div class="wrap">
		...
		<div  class=" well login">
			...
			<td style="border-top:0px;"> <input class="btn btn-success" type="submit" value="Login"></td>
			</tr>
			<tr>
			...
			<tr>
			<td style="border-top:0px;"></td>
			<td style="border-top:0px;"> <a class="btn btn-success" href="signup.php?value=0">Signup</a></td>
			</tr>
