	...
	<div class="wrap">
		...
		<div class="row">
			...
			<table class="table">
				...
				<tr>
					<td style="border-top:0px;"><input class="btn btn-success" type="submit" value="OK"></td>
					<td style="border-top:0px;"><a href="reservation.php" class="btn btn-success" type="reset" value="Reset">Reset</a></td>
				</tr>
			</table>
			</form>
			</div>
		...
		<!-- display bus -->
			<div class="span8 well">
				...
				<table class="table">
				<tr>
					<th style="width:80px;border-top:0px;"> Bus No.</th>
					<th style="width:270px;border-top:0px;"> Bus Name </th>
				...
				<tr class="text-error">
					...
					<td style="width:200px;">  
						<a class="text-error" href="reser.php?bno=<?php echo$row['Number']?>&fromstn=<?php echo $fromstn ?>&tostn=<?php echo $tostn ?>&doj=<?php echo $doj ?>&quota=<?php echo $quota;?>&class=<?php echo "1A";?>"><b>1A</b></a> 
						<a class="text-error" href="reser.php?bno=<?php echo$row['Number']?>&fromstn=<?php echo $fromstn ?>&tostn=<?php echo $tostn ?>&doj=<?php echo $doj ?>&quota=<?php echo $quota;?>&class=<?php echo "2A";?>"><b>2A</b></a>
						<a class="text-error" href="reser.php?bno=<?php echo$row['Number']?>&fromstn=<?php echo $fromstn ?>&tostn=<?php echo $tostn ?>&doj=<?php echo $doj ?>&quota=<?php echo $quota;?>&class=<?php echo "3A";?>"><b>3A</b></a> 
						<a class="text-error" href="reser.php?bno=<?php echo$row['Number']?>&fromstn=<?php echo $fromstn ?>&tostn=<?php echo $tostn ?>&doj=<?php echo $doj ?>&quota=<?php echo $quota;?>&class=<?php echo "SL";?>"><b>SL</b></a> 
				...
				<tr class="text-info">
					...
					<td style="width:65px;"> <?php  echo $d; ?> </td>
					<td style="width:200px;">
						<a class="text-info" href="reser.php?bno=<?php echo$row['Number']?>&fromstn=<?php echo $fromstn ?>&tostn=<?php echo $tostn ?>&doj=<?php echo $doj ?>&quota=<?php echo $quota;?>&class=<?php echo "1A";?>"><b>1A</b> </a> 
						<a class="text-info" href="reser.php?bno=<?php echo$row['Number']?>&fromstn=<?php echo $fromstn ?>&tostn=<?php echo $tostn ?>&doj=<?php echo $doj ?>&quota=<?php echo $quota;?>&class=<?php echo "2A";?>"><b>2A</b></a>
						<a class="text-info" href="reser.php?bno=<?php echo$row['Number']?>&fromstn=<?php echo $fromstn ?>&tostn=<?php echo $tostn ?>&doj=<?php echo $doj ?>&quota=<?php echo $quota;?>&class=<?php echo "3A";?>"><b>3A</b></a>
						<a class="text-info" href="reser.php?bno=<?php echo$row['Number']?>&fromstn=<?php echo $fromstn ?>&tostn=<?php echo $tostn ?>&doj=<?php echo $doj ?>&quota=<?php echo $quota;?>&class=<?php echo "SL";?>"><b>SL</b></a>
					</td>
				</tr>
				<?php  
					}
				...
				{
					echo "<div class=\"alert alert-error\"  style=\"margin:100px 180px;\"> please search the bus.. </div>";
				}
