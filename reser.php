...
<body style="background :	#F0E68C">
	...
	<div class="wrap">
		...
		<div class="header">
			...
			<div id="heading">
				<a href="index.html"> Bus Reservation </a>
			</div>
			</div>
		</div>
		...
		<form method="get" action="booking.php">
				...
				<tr>
					...
					<th style="border-top:0px;"> Bus No./Name:</th>
				...
				<tr>
					...
					<td style="border-top:0px;"> <?php echo $_GET['bno'];?> </td>
					<input name="bno" style="display:none;" type="text" value="<?php echo $_GET['bno'];?>"> </td>
		...
		<h2><font color="blue">Passenger Detail</font></h2>
			...
			<table class="table">
				...
				<tr>
					<td style="border-top:0px;"><input class="btn btn-success"type="submit" value="Submit" id="subb" ></td>
					<td style="border-top:0px;"><input class="btn btn-success"type="reset" value="Reset"></td>
				</tr>	
