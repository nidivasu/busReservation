	...
	<div class="wrap">
		...
		<div class="span12 well" id="boxh">
			...
			<table class="table" style="margin-bottom:0px;">
				<tr>
					<th style="border-top:0px;"><label><b>Search Bus</b></label></th>
					...
					<td style="border-top:0px;"><input class="btn btn-success" type="submit" value="Find"> </td>
					<td style="border-top:0px;"><a href="bus.php" class="btn btn-success" type="reset" value="Reset">Reset</a></td>
				</tr>
			</table>
			</form>
		</div>
<!-- display result -->
		<div class="span12 well">
			<div class="display" style="height:30px;">
				...
				<tr>
					<th style="width:70px;border-top:0px;"> Bus No.</th>
					<th style="width:210px;border-top:0px;"> Bus Name </th>
			...
			<div class="display" style="margin-top:0px;overflow:auto;">
				...
				{
				    echo "<div class=\"alert alert-error\"  style=\"margin:100px 350px;\"> please search the Bus.. </div>";
				}
				mysqli_close($conn);
				?>
				</table>
