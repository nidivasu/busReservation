...
mysqli_select_db($conn,"$db_name") or die("cannot select db");
	...
	$tostn=$_GET['tostn'];
	$DOB=$_GET['DOB'];
	$sql="SELECT Bnumber,doj,Name,Age,Sex,Status,DOB,class FROM $tbl_name WHERE (uname='$name1' and Bnumber='$bno' 
	and doj='$doj' and DOB='$DOB' and fromstn='$fromstn' and tostn='$tostn')";
...
<body style="background :	#F0E68C">
	...
	<div >
				...
				?>
				<?php 
				$sql2="Select ".$class." from bus_list WHERE Number=$bno";
				//echo $sql2;
